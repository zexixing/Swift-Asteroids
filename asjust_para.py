...
def extraAster_point(obs,aster,ra,dec,mode,ext=1):
    ...
    os.system('mv '+docsdir+'/sw'+obsid+'ugu_1ord_'+str(int(ext))+'_g.pha'+' '+docsdir+'/'+obsid+adjname+'.pha')
    os.system('mv '+docsdir+'/sw'+obsid+'ugu_1ord_'+str(int(ext))+'_g_back.pha'+' '+docsdir+'/'+obsid+adjname+'_back.pha')
...
sky_dict = {'wd1057':(165.1425,71.63441667),
            ...
            'p330':(247.891042, 30.146417),
            'hd189733':(300.18213766, 22.71085328)}
obs_dict = {'wd1057':['00055216001'],#'00055205001','00055211004','00055900069'],
            ...
            'bd25':['00057538004'],
            'agk81':['00057530014'],#'00057530004','00057530006','00057530012'],
            ...
            'wd1657':['00055900069'],
            'p330':['00056770015'],
            'hd189733':['00033910001','00033910004'],}
'''
from astropy.io import fits
from os.path import isfile
for star in ['hd189733']:#obs_dict.keys():
    print(star)
...
'''
#ra, dec = getRadec('00014048004',16,'@swift','psyche')
#print(ra,dec)
#extraAster_point('00014048004','../psyche',ra,dec,'160',1)
...
def extraAster(obs,aster,horizon_id):
    ...
    os.system('mv '+docsdir+'/sw'+obsid+'ugu_1ord_1_g.pha'+' '+docsdir+'/'+obsid+adjname+'.pha')
    os.system('mv '+docsdir+'/sw'+obsid+'ugu_1ord_1_g_back.pha'+' '+docsdir+'/'+obsid+adjname+'_back.pha')
    #os.system('rm *.png')
...
aster_dict = {#'psyche':16, 'ceres':1, 'juno':3, 'hebe':6, 
              #'dembowska':349,
              #'eunomia':15, 'flora':8, 'hygiea':10, #'eros':433, 
              #'iris':7, 'lutetia':21, 'massalia':20, 'nysa':44,
              #'pallas':2, 
              'themis':24, 
              #'vesta':4,'scheila':596,'toutatis':4179
              }
#aster_dict = {'juno':3}
#aster = 'juno'
#aster_id = 3
...
for aster in aster_dict.keys():
    ...
    idlist = ugrismlist(aster,filt='uvgrism')
    print(idlist)
    for obsid in idlist:
